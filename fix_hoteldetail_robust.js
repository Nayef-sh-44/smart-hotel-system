...
code = code.replace(
  "import {\n  Star,",
  "import {\n  Banknote, Utensils, ShoppingBag, HeartPulse, Train, TreePine, Ticket, Church, Loader2, Navigation, Compass,\n  Star,"
);
...
// 3. Replace the Nearby Services right column
...
const rightColReplacement = `
            ...
            <div className="glass-panel p-6">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 mb-4 pb-4 border-b border-slate-200 dark:border-slate-800">
                Live OpenStreetMap data (Max 3km radius). Sorted by relevance for your trip type.
              </p>
...
`;
code = code.substring(0, startIndex) + rightColReplacement.trim() + code.substring(endIndex);
