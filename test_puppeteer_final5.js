...
(async () => {
    ...
    // Wait for the loader to disappear, up to 15 seconds
    console.log("Waiting for loader to disappear...");
    await page.waitForFunction(() => {
        return !document.body.innerText.includes("Scanning surrounding area");
    }, { timeout: 15000 }).catch(() => console.log("Timeout waiting for loader to disappear"));
    
    await new Promise(r => setTimeout(r, 2000));
    
    await page.screenshot({ path: 'screenshot_final5.png', fullPage: true });
